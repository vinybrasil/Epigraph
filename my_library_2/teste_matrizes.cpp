...
int main()
{
    ...
    q << -Y, q_zero;
    std::cout << "vec_joined:\n" <<  q <<  std::endl;
    //std::cout << "vec_joined tail:\n" <<  vec_joined.tail(m) <<  std::endl;
    //std::cout << "vec_joined head:\n" <<  vec_joined.head(m*n_0) <<  std::endl;
